...
from bedrock_llm_router import BedrockLLMRouter
...
LOG_PATH = os.environ.get("LOG_PATH", "eval_logs_folder/run_test50_llama.log")
        ...
        try:
            ...
            for _ in range(N_SAMPLES):
                ...
                if used_structured:
                    ...
                    fallback_ct += 1
                used_structured_any = used_structured_any or used_structured
...
'''
    ...
    for question_key, question_info in question_dictionary.items():
        ...
        if splits:
            ...
            response = None
            if subprompts:
                for sp_idx, subprompt in enumerate(subprompts):
                    ...
                    append_vote_log({
                        ...
                        "prompt_kind": "subprompt",
                        "subprompt_idx": sp_idx,
                        "has_splits": True,
                        "n_splits": len(splits),
                    ...
                    if str(response.get('option', '')).lower() == 'yes':
                        break
            else:
                prompt = prompt_question.format(
                    corpus=question_info['corpus'],
...
output_dir = 'complication_results_folder/complication_results_wt_test20_llama_simple'
